...
public class Procedural : MonoBehaviour
{
    ...
    public static Mesh GeneratePlaneMesh(int rows, int columns)
    {
        ...
        for (int i = 0, y = 0; y <= columns; y++)
        {
            ...
            {
                vertices[i] = new Vector3(x / (float)rows, y / (float)columns);
        ...
        for (int ti = 0, vi = 0, y = 0; y < columns; y++, vi++)
        {
            ...
            {
                triangles[ti] = vi;
                triangles[ti + 1] = vi + rows + 1;
                triangles[ti + 2] = vi + 1;
                triangles[ti + 3] = vi + 1;
                triangles[ti + 4] = vi + rows + 1;
