...
\setthesistitle{Mesh Manipulation in Unity}
\setthesisshorttitle{Mesh Manipulation in Unity} % a short version for the page headers if your normal title is too long to fit
