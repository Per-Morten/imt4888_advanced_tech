...
Firstly one must decide upon the model to use for the mesh deformation, the more brute-force spring mass system, rather than a more algorithmical approach using proper physics.
As previously indicated we are working with a spring mass system for this implementation.
